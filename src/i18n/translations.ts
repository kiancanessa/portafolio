    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Sitio inmobiliario bilingüe en Rosarito, con navegación por intención — comprar, rentar, vender o asesoría legal — y catálogo de propiedades.",
          tags: ["Next.js", "React", "Bilingüe"],
        },
        {
          n: "03",
          category: "Producto propio",
          name: "Recorridos 3D",
          desc: "Convierte las propiedades de EasyBroker en recorridos 3D, con un asesor de IA que responde dentro del recorrido las 24 horas.",
          tags: ["Next.js", "EasyBroker", "IA"],
        },
        {
          n: "04",
          category: "Producto propio",
          name: "InmoCRM",
          desc: "CRM inmobiliario con pipeline visual, priorización de prospectos, comisión proyectada y match inverso de propiedades.",
          tags: ["Next.js", "React", "IA"],
        },
        {
          n: "05",
          category: "Cliente",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          category: "Client",
          name: "Grupo Lemus Realty",
          desc: "Bilingual real-estate site in Rosarito with intent-based navigation — buy, rent, sell or legal advice — and a property catalog.",
        ...
        },
        {
          ...
          name: "Recorridos 3D",
          desc: "Turns EasyBroker properties into 3D tours, with an AI advisor that answers inside the tour 24/7.",
          tags: ["Next.js", "EasyBroker", "AI"],
        },
        {
          n: "04",
          category: "Own product",
          name: "InmoCRM",
          desc: "Real-estate CRM with a visual pipeline, lead prioritization, projected commission and reverse property matching.",
